    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full text-center flex flex-col items-center space-y-8 sm:space-y-12">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-7xl md:text-[9rem] font-display italic text-text-primary leading-tight sm:leading-none break-words w-full px-2">
            Let's build something <span className="text-[#89AACC]">meaningful</span>.
          </h2>
          <p className="text-text-primary/90 text-xs sm:text-xl lg:text-2xl max-w-xl font-body leading-relaxed px-2">
